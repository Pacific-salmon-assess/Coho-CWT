...
CAreleasedata <- read.csv('~/Canada Releases.csv')
...
AKreleasedata <- read.csv('~/Alaska Releases.csv')
...
CAcwtdata <- read.csv('~/Canada Recoveries.csv')
...
AKcwtdata <- read.csv('~/Alaska Recoveries.csv')
...
fisherycodedata <- read.csv('~/export definitions(PSC fishery).csv')
